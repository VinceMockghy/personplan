...
public class BeanStep {
	...
	public String getCell(int col){
		if(col==0) return Integer.toString(this.getStep_order());
		else if(col==1) return this.getStep_name();
		else if(col==2) return Format.format(this.plan_begin_time);
		else if(col==3) return Format.format(this.plan_end_time);
		else if(col==4) return this.getReal_begin_time()==null? "":Format.format(this.real_begin_time);
		else if(col==5) return this.getReal_end_time()==null? "":Format.format(this.real_end_time);
